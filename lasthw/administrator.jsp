...
<head>
  ...
  <style>
   @import url("asset/administrator.css") ;
    </style>
...
<%
    ...
    <div class="ch2"><a class="active" href="index.jsp"><p class="txthome">主頁</p></a></div>
		<img src="img1/logo.jpg" class="imglogo">
  		<div class="ch3"><a href="#a"><p class="txthome">熱銷商品</p></a></div>
...
//Step 5: 顯示結果 
		  ...
		  %> 
		   ...
		   %>
			...
			<table style="position:absolute;top: 1310px;left: 580px;font-size: 30px;font-weight: bold;">
			...
			<tr>
			<td><input type="submit" value="確認修改" style="font-size: 20px"></input></td>
			</form>
			</tr>
			...
			<div class="user" id="mess">
				<h1 style="position:absolute;top: 1500px;left: 580px;color: #FF2626;font-size: 50px;font-weight: bold;" id="update" >會員購買紀錄</h1>
				<hr style="position: absolute;top: 1590px;width: 40%;left: 400px; color:#FF2626 ">
				
				<p class="solid1" style="position:absolute;top: 1680px;left: 440px;font-size: 30px;font-weight: bold;height:500px;">
				<%
