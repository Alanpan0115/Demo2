...
<%
	...
	else
	{
		...
		if(left>=x){
			...
			int total=price*x;
			request.setCharacterEncoding("UTF-8");
			sql="insert into stock(ID,name,price,img,amount,total) values('"+(String)session.getAttribute("member")+"','"+request.getParameter("name")+"','"+price+"','"+request.getParameter("img")+"','"+num+"','"+total+"')";
