...
<body>
  ...
  <div class="a">
  	<p class="txtt1">可愛造形小夜燈</p>
    </div>
   <div class="line1">
   </div>
  <div class="b">
  	<img src="img1/l3.jpg" class="imgpro1"> 
  		<a href="cart2.jsp"><button >加入購物車</button></a>
  	<p class="money">狗狗小夜燈<p>
  ...
  <div class="c">
  	<img src="img1/l4.jpg" class="imgpro1"> 
  		<a href="cart3.jsp"><button >加入購物車</button></a>
  	<p class="money">幽靈小夜燈<p>
  	<p class="money">售價:298</p>
  	<p class="money">存貨有限，</p>
  	<p class="money">要買要快</p>
  </div>
  </div>
  <div class="d">
  	<img src="img1/t1.jpg" class="imgpro1"> 
  		<a href="cart4.jsp"><button >加入購物車</button></a>
  	<p class="money">兔兔小夜燈<p>
  	<p class="money">售價:338</p>
  	<p class="money">存貨有限，</p>
  	<p class="money">要買要快</p>
  </div>
  </div>
