...
<body  style="background-image: url(img1/background.jpg);height: 1450px;">
	...
	<div>
		<img src="img1/l1.jpg" style="position: absolute;top: 160px;left: 600px;width: 380px;height: 380px;">
		<p style="padding:5px 200px 5px 5px;background-color: #F5F5F5;position: absolute;top: 140px;left: 1010px;font-size: 40px;color: red;">聖誕小夜燈</p>
		<p style="position: absolute;top: 230px;left: 1010px;font-size: 25px;">燈光從漫天大雪中緩緩流淌出來，<br>那橙色的光芒匯聚成一陣陣暖流，<br>像極了冬日裡的太陽，<br>溫暖了我們的內心。</p>
		<p style="font-size: 35px;position:absolute;top: 360px;left: 1010px;">售價：</p>
		<div style="color: red;position: absolute;top: 395px;left: 1110px;font-size: 35px;">$220</div>
