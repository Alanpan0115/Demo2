...
<body style="background-image: url(img1/background.jpg);height: 1450px;" >
	...
	<div>
		<img src="img1/t1.jpg" style="position: absolute;top: 160px;left: 600px;width: 380px;height: 380px;">
		<p style="padding:5px 200px 5px 5px;background-color: #F5F5F5;position: absolute;top: 140px;left: 1010px;font-size: 40px;color: red;">兔兔小夜燈</p>
		<p style="position: absolute;top: 230px;left: 1010px;font-size: 25px;">當你睡覺前看一眼<br>這個無比可愛的小兔子，<br>心情是不是都會好起來，<Br>相信它定會帶給你一個好夢。</p>
		<p style="font-size: 35px;position:absolute;top: 360px;left: 1010px;">售價：</p>
		<div style="color: red;position: absolute;top: 395px;left: 1110px;font-size: 35px;">$338</div>
