...
<body style="background-image: url(img1/background.jpg);height: 1450px;" >
	...
	<div>
		<img src="img1/l3.jpg" style="position: absolute;top: 160px;left: 600px;width: 380px;height: 380px;">
		<p style="padding:5px 200px 5px 5px;background-color: #F5F5F5;position: absolute;top: 140px;left: 1010px;font-size: 40px;color: red;">狗狗小夜燈</p>
		<p style="position: absolute;top: 230px;left: 1010px;font-size: 25px;">第一眼看到這個小狗的時候，<br>心都要被萌化了。<br>它就安靜的趴在桌子上守護著你，<br>讓你享受一個安靜美好的夜晚。</p>
		<p style="font-size: 35px;position:absolute;top: 360px;left: 1010px;">售價：</p>
		<div style="color: red;position: absolute;top: 395px;left: 1110px;font-size: 35px;">$320</div>
