...
%>
	...
	<table style="position: absolute;top: 220px;font-size: 30px;font-weight: bold;left: 270px">
    	...
    	<div class="block">	   
            <div class="b_left">
                <img width="150" height="150" src=<%out.print(rs1.getString("img"));%> class="show"
                </img>
            </div>
			
            <div class="b_right">
                <p class="text" style="font-size: 25px;"><%out.print(rs1.getString("name"));%></p>
                <p class="text" style="font-size: 20px;">單價:<%out.print(rs1.getString("price"));%></p>
                <p class="text" style="font-size: 20px;">數量:<%out.print(rs1.getString("amount"));%></p>
		...
		<div class="center" style="position: absolute;top: 200px;font-size: 30px;font-weight: bold;left: 270px;">
		
			<p class="text">您的購物車沒有任何商品!</p>
			</div>
		 
			<div class="btn" style="position: absolute;top: 280px;font-size: 30px;font-weight: bold;left: 270px;">
	...
	<table  style="position: absolute;top: 1140px;font-size: 50px;font-weight: bold;left: 270px;">
